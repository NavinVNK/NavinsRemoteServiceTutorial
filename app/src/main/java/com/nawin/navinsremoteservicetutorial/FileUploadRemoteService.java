...
public class FileUploadRemoteService extends Service {
    private static final String SRMUNIV_INTENT_ACTION_BIND_MESSAGE_SERVICE = "srmuniv.intent.action.bindMessageService";
    private final static String LOG_TAG = FileUploadRemoteService.class
            .getCanonicalName();
    ...
    String uploadForRemoteService(String sourceFileUri) {
        ...
        String upLoadServerUri = "http://navinsandroidtutorial.esy.es/upload/upload.php";
    ...
    public class UploadFileService extends IRemoteFileUpload.Stub {
        @Override
